        ...
        <div class="modal-body">
          <div class="col">
            ...
            <div class="form-group">
              ...
              <input type="text" pattern="[A-Za-z ]{3,30}" name="Esp" id="Des_edit" class="form-control" placeholder="Descripcion" minlength="3" maxlength="30" style="text-transform: uppercase;" required>
            </div>
          </div>
        </div>
