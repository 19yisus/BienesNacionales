...
<body class="hold-transition sidebar-mini">
  ...
  <div class="content-wrapper">
    <?php $this->Wraper('Catalogo','Modelos/Vis_Index','Registro de Modelos');?>
    <!-- Main content -->
    <div class="content">
...
<?php $this->Footer('Modelos'); ?>
<script src="<?php echo constant('URL');?>Views/Js/GLOBAL.js"></script>
<script>
  ShowCodigo_incrementado('<?php echo constant('URL').'ModelosController'?>',document.formulario.Cod)
