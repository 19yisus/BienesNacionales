        ...
        <div class="modal-body">
          <div class="col">
            <div class="form-group">
              ...
              <input type="text" name="Cod" id="Cod_edit" class="form-control" placeholder="Codigo" minlength="1" maxlength="2" readonly>
            </div>
            <div class="form-group">
              <label for="">Descripcion</label><label for="" id="ob">*</label>
              <input type="text" pattern="[A-Za-z ]{2,30}" name="Marca" id="Des_edit" class="form-control" placeholder="Descripcion" minlength="3" maxlength="30" style="text-transform: uppercase;" required>
            </div>
            <div class="form-group">
              <label for="">Categoria</label><label for="" id="ob">*</label>
              <select name="Tip" id="Tip_edit" class="custom-select" required>
              <?php echo $this->Control('MarcasController')->SelectCategoria(); ?>
              </select>
            </div>
          </div>
        </div>
